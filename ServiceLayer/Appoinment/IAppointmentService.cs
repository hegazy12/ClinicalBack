...
public interface IAppointmentService
{
    ...
    public Task<GeneralResponse<List<AppointmentDTO_2>>> GetByCreatby(Guid Createby);
    public Task<GeneralResponse<List<AppointmentDTO_1>>> GetByDoctor(Guid DoctorId);
    public Task<GeneralResponse<List<AppointmentDTO_2>>> GetByPatient(Guid PatientId);
