...
namespace DatabaseLayer.Migrations
{
    ...
    [Migration("20260924140810_saveServicesModule")]
    partial class saveServicesModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.ExaminationFinding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.MainQuestion", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("listValues")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("requer")
                        .HasColumnType("bit");

                    b.Property<bool>("requeried")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.Models.Question", b =>
                {
                    ...
                    b.Property<Guid?>("QuestionDependId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.saveExaminationFinding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ExaminationFindingId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ExaminationFindingId");

                    b.HasIndex("UpdatedBy");

                    b.ToTable("saveExaminationFinding");
                });

            modelBuilder.Entity("Domain.Models.saveExaminationPhotos", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("saveExaminationPhotos");
                });

            modelBuilder.Entity("Domain.Models.saveMainQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("MainQuestionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("saveMainQuestions");
                });

            modelBuilder.Entity("Domain.Models.saveQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.saveService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.saveVitalSign", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.Question", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Question", "QuestionDepend")
                        .WithMany("questionsDependOnMe")
                        .HasForeignKey("QuestionDependId");
            ...
            modelBuilder.Entity("Domain.Models.saveExaminationFinding", b =>
                {
                    ...
                    b.HasOne("Domain.Models.ExaminationFinding", "ExaminationFinding")
                        .WithMany()
                        .HasForeignKey("ExaminationFindingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ExaminationFinding");
            ...
            modelBuilder.Entity("Domain.Models.saveExaminationPhotos", b =>
                {
                    ...
                    b.HasOne("Domain.Models.saveExamination", "saveExamination")
                        .WithMany("ExaminationPhotos")
                        .HasForeignKey("examinationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Models.saveVitalSign", b =>
                {
                    ...
                    b.HasOne("Domain.Models.VitalSign", "VitalSign")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Models.Question", b =>
                {
                    b.Navigation("questionsDependOnMe");
                });
            ...
            modelBuilder.Entity("Domain.Models.saveExamination", b =>
                {
                    b.Navigation("ExaminationPhotos");
                });
