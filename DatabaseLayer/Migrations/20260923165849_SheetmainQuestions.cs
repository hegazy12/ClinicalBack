...
{
    /// <inheritdoc />
    public partial class SheetmainQuestions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    listValues = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Gendar = table.Column<int>(type: "int", nullable: false),
                    age = table.Column<int>(type: "int", nullable: false),
                    requer = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_mainQuestions_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_mainQuestions_AspNetUsers_DeletedBy",
                        column: x => x.DeletedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_mainQuestions_AspNetUsers_UpdatedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_mainQuestions_CreatedBy",
                table: "mainQuestions",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_mainQuestions_DeletedBy",
                table: "mainQuestions",
                column: "DeletedBy");

            migrationBuilder.CreateIndex(
                name: "IX_mainQuestions_UpdatedBy",
                table: "mainQuestions",
                column: "UpdatedBy");
        }
